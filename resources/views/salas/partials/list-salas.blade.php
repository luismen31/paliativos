<div class="row">
    <div class="col-sm-12">
            <div class="panel panel-primary panel-filter">
                ...
                <h3 class="panel-title"><i class="fa fa-filter"></i> Lista de Salas</h3>
            </div>
            <div class="panel-body">
                <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-table" placeholder="Filtrar Salas" />
            </div>
                    ...
                    <tbody>
                        ...
                        @foreach(\App\Sala::all() as $sala)
                            <tr>
                                ...
                                <td>{{ $sala->SALA }}</td>
                                <td>
                                    <a href="{{ route('salas.edit', $sala->ID_SALA).'#form' }}" class="btn btn-success"><i class="fa fa-edit"></i> Editar</a>
                                </td>
                            </tr>
                            {{--*/ $x++; /*--}}
                        @endforeach
