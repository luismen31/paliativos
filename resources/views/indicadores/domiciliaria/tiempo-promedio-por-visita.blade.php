...
@section('title')
	Indicadores Domiciliaria - Tiempo Promedio empleado por Visitas
@stop


@section('content')
	
	<h2 class="page-header">Tiempo Promedio empleado por Visitas</h2>

	@include('mensajes.errors')

	{!! Form::open(['route' => 'filtrarTiempoPromedio', 'method' => 'POST'])!!}
		<div class="row">
