<div class="row">
    <div class="col-sm-12">
            <div class="panel panel-primary panel-filter">
                ...
                <h3 class="panel-title"><i class="fa fa-filter"></i> Lista de Zonas</h3>
            </div>
            <div class="panel-body">
                <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-table" placeholder="Filtrar Zonas" />
            </div>
                    ...
                    <tbody>
                        ...
                        @foreach(\App\Zona::all() as $zona)
                            <tr>
                                ...
                                <td>{{ $zona->ZONA }}</td>
                                <td>
                                    <a href="{{ route('zona.edit', $zona->ID_ZONA).'#form' }}" class="btn btn-success"><i class="fa fa-edit"></i> Editar</a>
                                </td>
                            </tr>
                            {{--*/ $x++; /*--}}
                        @endforeach
