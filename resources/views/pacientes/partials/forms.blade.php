<div class="panel panel-info">
    <div class="panel-heading">
      <h3 class="panel-title"><i class="fa fa-info-circle"></i> <strong>Datos de Identificación</strong></h3>
    </div>
...
<div class="panel panel-info">
    <div class="panel-heading">
      <h3 class="panel-title"><i class="fa fa-user"></i> <strong>Datos Personales Del Paciente</strong></h3>
    </div>
    <div class="panel-body">
    	<div class="row">
			<div class="form-group col-sm-4">
			...
			<div class="form-group col-sm-4">
				...
				{!! Form::select('ID_SEXO', array('0'=>'SELECCIONE SEXO') + \App\Sexo::lists('SEXO', 'ID_SEXO')->toArray(), null, array('class'=>'form-control input-sm')) !!}
			</div>
			<div class="form-group col-sm-4">
...
<div class="panel panel-info">
    <div class="panel-heading">
      <h3 class="panel-title"><i class="fa fa-map-marker"></i> <strong>Datos de Contacto/Dirección</strong></h3>
    </div>
    <div class="panel-body">
		<div class="row">
			<div class="form-group col-sm-4">
...
<div class="panel panel-info">
    <div class="panel-heading">
      <h3 class="panel-title"><i class="fa fa-lock"></i> <strong>Datos de Autenticación</strong></h3>
    </div>
    <div class="panel-body">
    	<div class="row">
			<div class="form-group col-sm-4">
			...
			<div class="form-group col-sm-4">
				...
				{!! Form::select('PREFERENCIA_RECUPERACION', array('0'=>'SELECCIONE PREFERENCIA RECUPERACIÓN', '1' => 'PREGUNTA', '3' => 'CORREO') , null, array('class'=>'form-control input-sm')) !!}
			</div>
			<div class="form-group col-sm-4">
			...
			<div class="form-group col-sm-4">
				...
				{!! Form::text('CUIDADOR', null, array('class'=>'form-control input-sm', 'placeholder' => 'Cuidador Primario') ) !!}   
			</div>
			<div class="form-group col-sm-4">
			    {!! Form::label('PARENTEZCO_CUIDADOR', 'Parentezco Cuidador:', array('class' => 'control-label')) !!}    
				{!! Form::text('PARENTEZCO_CUIDADOR', null, array('class'=>'form-control input-sm', 'placeholder' => 'Parentezco Cuidador') ) !!}   
			</div>
			<div class="form-group col-sm-4">
